...
INSERT INTO ANO_DEPT(DEPT_ID, DEPT_NAME) VALUES(4,'FULL-STACK DEVELOPER'),(1,'SQL DEVELOPER'),(2,'FRONT-END DEVELOPER'),(3,'BACK-END DEVELOPER');
UPDATE  ANO_DEPT SET DEPT_ID = 1004 WHERE DEPT_ID = 4
...
DROP TABLE EMP
INSERT INTO EMP(EMP_ID, EMP_NAME, DEPT_ID, SALARY) VALUES (11,'SASUKE',NULL,20000)
...
-- _____________________________________________________
 ...
 -- INNER JOIN :
  SELECT * 
  FROM EMP A
  INNER JOIN ANO_DEPT B ON A.DEPT_ID = B.DEPT_ID; -- BRINGS ONLY MATCHED RECS IN BOTH TABLES / RETURNS EMP WHOSE HAVE THEIR DEPT 
  
  -- LEFT JOIN :
  SELECT * 
  FROM EMP A
  LEFT JOIN ANO_DEPT B ON A.DEPT_ID = B.DEPT_ID; -- TELLS THERE IS ONE RECORD WHICH HAVE NOT SET DEPT YET
  
  -- RIGHT JOIN :
  SELECT * 
  FROM EMP A
  RIGHT JOIN ANO_DEPT B ON A.DEPT_ID = B.DEPT_ID; -- TELLS THERE IS NO EMP IN FULL_STACK DEPT
  -- _____________________________________________________